...
class Index {
  ...
  constructor (options) {
    ...
    const compareFunc = Array.isArray(this.fieldName) ? model.compoundCompareThings(this.fieldName) : model.compareThings
  ...
  insert (doc) {
    ...
    if ((key === undefined || R.isEmpty(key)) && this.sparse) return
